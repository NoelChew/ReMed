...
public class MedicineData {
    ...
    public static ArrayList<Medicine> getMedicineArrayList() {
        ...
        for (int i = 0; i < 3; i++) {
            Medicine medicine = new Medicine(String.valueOf(i), "Medicine " + String.valueOf(i + 1), "https://dummyimage.com/400x400/212121/fff.jpg&text=Medicine+" + String.valueOf(i + 1), "DEC 2019");
